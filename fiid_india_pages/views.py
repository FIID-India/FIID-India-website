...
def home_page_view(request):
    ...
    try:
        ...
        context["programmes_images"] = programmes.image_set.all().order_by(
            '-id')[:1]
    except ObjectDoesNotExist:
        pass
    ...
    try:
        ...
        context["objectives_images"] = objectives.image_set.all().order_by(
            '-id')[:1]
    except:
        pass
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            subscriber_welcome_email(
                full_name, subject, recipient, 'welcome.html')
